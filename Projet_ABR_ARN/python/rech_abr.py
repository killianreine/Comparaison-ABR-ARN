...
chemin_fichier = 'src/main/ressources/csv/rechercheABR.csv'
...
plt.title("Recherche ABR : temps en fonction de la taille de l'arbre")
plt.legend()
plt.grid()

# Sauvegarde
plt.savefig("src/main/ressources/image/recherche_abr_moyLISSE.png")
